...
export default function MiEDeptPage() {
  const labs = ['Ore Dressing Lab', 'Flotation Lab', 'Hydrometallurgy Lab', 'Crushing & Grinding Lab', 'Chemical Analysis Lab']
  const recruiters = ['NALCO', 'IMFA', 'Vedanta', 'Hindalco', 'NMDC', 'OMC', 'KIOCL', 'SAIL']
    ...
    <div>
      ...
      <div className="page-banner">
        <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.45)', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '4px' }}>
          Home → Departments → Mineral Engineering
        </p>
        <h1 style={{ fontFamily: 'Source Serif 4, serif', fontSize: '24px', fontWeight: 600, color: 'white' }}>Mineral Engineering</h1>
      </div>

      {/* Dept Info Strip */}
      <div className="dept-info-strip">
        <span><strong style={{ color: 'var(--text)' }}>Code:</strong> MiE</span>
        ...
        <span><strong style={{ color: 'var(--text)' }}>HOD:</strong> Prof. Durga Prasad Mishra</span>
        <span><strong style={{ color: 'var(--text)' }}>Email:</strong> <a href="mailto:hod.mie@gcekjr.ac.in" style={{ color: 'var(--blue-mid)' }}>hod.mie@gcekjr.ac.in</a></span>
      </div>
      ...
      <div className="page-wrap">
        ...
        <p style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.9, marginBottom: '36px' }}>Mineral Engineering deals with the processing of ores and minerals — covering comminution, classification, gravity concentration, flotation, magnetic separation, hydrometallurgy, and pyrometallurgy. Students learn to design mineral processing plants and operate pilot-scale equipment. Given Keonjhar's rich mineral deposits, this department has a uniquely relevant industrial context and strong recruiter interest.</p>
