...
export default function EEDeptPage() {
  const labs = ['Electrical Machines Lab', 'Power Electronics Lab', 'Control Systems Lab', 'Power Systems Lab', 'Measurement & Instrumentation Lab']
  const recruiters = ['NALCO', 'OPGC', 'Vedanta', 'GRIDCO', 'BSNL', 'L&T', 'BHEL', 'NTPC']
    ...
    <div>
      ...
      <div className="page-banner">
        <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.45)', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '4px' }}>
          Home → Departments → Electrical Engineering
        </p>
        <h1 style={{ fontFamily: 'Source Serif 4, serif', fontSize: '24px', fontWeight: 600, color: 'white' }}>Electrical Engineering</h1>
      </div>

      {/* Dept Info Strip */}
      <div className="dept-info-strip">
        <span><strong style={{ color: 'var(--text)' }}>Code:</strong> EE</span>
        ...
        <span><strong style={{ color: 'var(--text)' }}>HOD:</strong> Prof. Ramakanta Mohanty</span>
        <span><strong style={{ color: 'var(--text)' }}>Email:</strong> <a href="mailto:hod.ee@gcekjr.ac.in" style={{ color: 'var(--blue-mid)' }}>hod.ee@gcekjr.ac.in</a></span>
      </div>
      ...
      <div className="page-wrap">
        ...
        <p style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.9, marginBottom: '36px' }}>The Electrical Engineering department trains students in power generation, transmission, distribution, electrical machines, control systems, power electronics, and renewable energy. Students are exposed to industrial automation and PLC-based systems through practical lab sessions. The department actively collaborates with GRIDCO and OPGC for industrial training programmes.</p>
